...
import ContentChat from "../../atoms/ContentChat/ContentChat";
import InputChat from "../../atoms/InputChat";
import styles from "./styles.module.css";
import { useActiveComponents } from "../../../context/ActiveChatContext";
import Conversation from "../../molecules/Conversation/Index";

export default function GeneralChat({ initialData }) {
  const {
    activeComponents,
    setActiveComponents,
    setNotificationId,
  ...
  return (
    <div
      className={`${styles.generalChat} ${
        activeComponents || finalChat ? styles.componentActive : ""
      }`}
    >
      {!modelChat ? (
        <ContentChat
        ...
        <Conversation question={modelChat} />
      )}
      <InputChat stateComponent={activeComponents} hideSubMenu={hideSubMenu} />
      <div
        className={`${styles.icoCloseChat} ${
          activeComponents || finalChat ? styles.icoCloseActive : ""
        }`}
        onClick={() => {
          setModelChat(null);
          setHideSubMenu(true);
