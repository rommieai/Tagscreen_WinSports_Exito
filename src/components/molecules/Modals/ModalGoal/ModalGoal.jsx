...
export default function ModalGoal() {
  ...
  const handleShare = () => {
    ...
    if (navigator.share) {
      navigator
        .share({ title: goalClip?.title ?? "¡GOL!", text, url })
        .catch(() => {});
    } else {
      window.open(
        ...
        {showReplay && (
          ...
          >
            ...
            <p className={styles.replayText}>
              ¡GOL! Celebra y compártelo con tus amigos
            </p>
